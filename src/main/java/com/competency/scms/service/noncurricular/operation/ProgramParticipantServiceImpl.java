...
import com.competency.scms.dto.noncurricular.operation.participant.ParticipantListItemDto;
...
import com.competency.scms.dto.noncurricular.operation.participant.ParticipantStatsDto;
    ...
    public ParticipantPageResponseDto search(Long programId, ParticipantSearchConditionDto cond, Pageable pageable) {
        ...
        List<ParticipantListItemDto> rows = page.map(pa ->
                ParticipantListItemDto.builder()
                        ...
                        .dept(pa.getStudent().getDepartment() != null ? pa.getStudent().getDepartment().getName() : null)
    ...
    public byte[] exportExcel(Long programId, ParticipantSearchConditionDto cond) {
        ...
        for (ProgramApplication pa : page.getContent()) {
            sb.append(pa.getApplicationId()).append(',')
                    ...
                    .append(s(pa.getStudent().getDepartment() != null ? pa.getStudent().getDepartment().getName() : null)).append(',')
